...
function render(input, out, __component, component, state) {
  ...
  out.w("<html><head><meta charset=\"utf-8\"><title>Lista de Livros</title></head><body>");

  component_globals_tag({}, out);

  out.w("<h1> Listagem de livros </h1><table id=\"livros\"><thead><tr><th>Código</th><th>Título</th><td>Preço</td><td>Editar</td><td>Remover</td></tr></thead><tbody>");
  ...
  out.w(" </tbody></table><script src=\"/estatico/js/remove-livro.js\">\r\n        </script> ");
